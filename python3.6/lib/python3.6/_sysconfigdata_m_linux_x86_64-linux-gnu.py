...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/usr/local/python3.6/bin',
 'BINLIBDEST': '/usr/local/python3.6/lib/python3.6',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '',
 'CONFIG_ARGS': "'--prefix=/usr/local/python3.6'",
 'CONFINCLUDEDIR': '/usr/local/python3.6/include',
 'CONFINCLUDEPY': '/usr/local/python3.6/include/python3.6m',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/root/Python-3.6.1/coverage.info',
 'COVERAGE_REPORT': '/root/Python-3.6.1/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/usr/local/python3.6 /usr/local/python3.6/lib '
             '/usr/local/python3.6/lib/python3.6 '
             '/usr/local/python3.6/lib/python3.6/lib-dynload',
 'DESTLIB': '/usr/local/python3.6/lib/python3.6',
 'DESTPATH': '',
 'DESTSHARED': '/usr/local/python3.6/lib/python3.6/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/usr/local/python3.6/include /usr/local/python3.6/include '
                   '/usr/local/python3.6/include/python3.6m '
                   '/usr/local/python3.6/include/python3.6m',
 'INCLUDEDIR': '/usr/local/python3.6/include',
 'INCLUDEPY': '/usr/local/python3.6/include/python3.6m',
 ...
 'LDVERSION': '3.6m',
 'LIBC': '',
 'LIBDEST': '/usr/local/python3.6/lib/python3.6',
 'LIBDIR': '/usr/local/python3.6/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/usr/local/python3.6/lib/pkgconfig',
 'LIBPL': '/usr/local/python3.6/lib/python3.6/config-3.6m-x86_64-linux-gnu',
 ...
 'LOCALMODLIBS': '-L/usr/local/ssl/lib -lssl -lcrypto  '
                 '-L/usr/local/python3.6/lib -lz',
 'LOG1P_DROPS_ZERO_SIGN': 0,
 'MACHDEP': 'linux',
 'MACHDEPPATH': ':',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/usr/local/python3.6/lib/python3.6',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/usr/local/python3.6/share/man',
 'MKDIR_P': '/usr/bin/mkdir -p',
 'MODLIBS': '-L/usr/local/ssl/lib -lssl -lcrypto  -L/usr/local/python3.6/lib '
            '-lz',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/usr/local/python3.6/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'abs_builddir': '/root/Python-3.6.1',
 'abs_srcdir': '/root/Python-3.6.1',
 'datarootdir': '/usr/local/python3.6/share',
 'exec_prefix': '/usr/local/python3.6',
